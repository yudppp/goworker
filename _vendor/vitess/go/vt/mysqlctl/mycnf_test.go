...
import (
	...
	"github.com/yudppp/goworker/_vendor/vitess/go/vt/env"
)
...
func TestMycnf(t *testing.T) {
	...
	cnfTemplatePaths := []string{
		path.Join(root, "src/github.com/yudppp/goworker/_vendor/vitess/config/mycnf/default.cnf"),
		path.Join(root, "src/github.com/yudppp/goworker/_vendor/vitess/config/mycnf/replica.cnf"),
		path.Join(root, "src/github.com/yudppp/goworker/_vendor/vitess/config/mycnf/master.cnf"),
	}
